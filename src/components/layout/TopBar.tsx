    ...
    <header className="sticky top-0 z-30 border-b border-line bg-bg/80 backdrop-blur">
      <div className="flex h-16 items-center gap-3 px-4 sm:px-6">
        ...
        <div className="flex items-center gap-2 lg:hidden">
          <div className="grid h-8 w-8 place-items-center rounded-lg bg-gradient-to-br from-accent to-sakura font-jp text-base font-bold text-accent-on">
            字
          </div>
        ...
        <div className="ml-auto hidden max-w-md flex-1 lg:block">
          <label className="relative block">
            ...
            <input
              ...
              className="h-10 w-full rounded-xl border border-line bg-bg-card pl-9 pr-3 text-sm text-fg placeholder:text-fg-faint focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/30"
            />
          </label>
        </div>

        <div className="ml-auto flex items-center gap-2 lg:ml-0">
          <div className="flex items-center gap-1.5 rounded-xl bg-bg-card px-3 py-1.5 ring-1 ring-inset ring-line">
          ...
          <button
            ...
            className="grid h-10 w-10 place-items-center rounded-xl text-fg-muted hover:bg-bg-hover hover:text-fg"
          >
