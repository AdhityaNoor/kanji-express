...
export const LESSON_DEFS: Record<CourseLevelId, Partial<Record<SectionId, LessonDef[]>>> = {
  ...
  N5: { overview: N5_OVERVIEW_COMPLETE, vocab: N5_VOCAB_COMPLETE, kanji: N5_KANJI_COMPLETE, grammar: N5_GRAMMAR_EXPANDED, listening: N5_LISTENING_COMPLETE, reading: N5_READING_COMPLETE, tests: N5_TESTS_COMPLETE },
